...
This project exists thanks to all the people who contribute. You can become a contributor by following the [contribution instructions](.github/CONTRIBUTING.md) and [the development docs](https://jekyll.github.io/jekyll-admin/development/).
