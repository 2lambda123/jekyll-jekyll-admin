...
permalink: /api/
description: >-
  A comprehensive guide to the HTTP API provided by Jekyll Admin: Prior to version 1.0.0, the HTTP API is to be considered a pre-release API, and is subject to breaking changes without
